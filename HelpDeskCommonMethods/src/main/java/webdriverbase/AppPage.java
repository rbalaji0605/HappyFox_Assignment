...
public class AppPage {
	 ...
	 * 
	  ...
	  ~ Constant Variables can be stored as global and properties file can be used
	  ~ Data from the properties can be read using class ReadPropertiesFile in utility package
	...
	/*
	 *  Actions class can be leveraged and used here if the application is not javascript specific
	 * 
	 * 
	 * 
	 */
...
/*
 * 
 * Navigation and scroll reusable methods can be defined in a separate class
 * 
 * 
 * 
 */
